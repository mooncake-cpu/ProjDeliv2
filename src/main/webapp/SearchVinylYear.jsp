...
<%
String search= request.getParameter("search3");
...
PreparedStatement ps = con.prepareStatement(
	    "SELECT c.artist, c.album_title, c.size, m.release_year " +
	    "FROM Vinyl c JOIN Music m USING(album_title) " +
	    "WHERE m.release_year LIKE ?"
	);
