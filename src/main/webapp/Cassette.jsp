...
%>
<form method="get" action="SearchCassettes.jsp" style="margin-bottom:20px;">
<input type="text" name="search" placeholder="Search Cassettes..."
...
<form method="get" action="SearchCassettesArtist.jsp" style="margin-bottom:20px;">
<input type="text" name="search2" placeholder="Search Artists..."
       style="padding:10px;width:300px;border-radius:8px;border:1px solid #ccc;">
<button type="submit" style="padding:8px 16px;border:none;border-radius:8px;background:#0078ff;color:white;">
    Search
</button>
</form>
<form method="get" action="SearchCassettesYear.jsp" style="margin-bottom:20px;">
...
"SELECT m.artist, m.album_title, m.release_year, ct.type FROM Music m JOIN Cassette ct ON m.artist=ct.artist AND m.album_title=ct.album_title"
);
